...
import com.dorkag.azure_devops.extensions.config.*
...
open class AzurePipelineExtension @Inject constructor(
    ...
    class StagesDsl(
        private val objects: ObjectFactory, private val stages: MapProperty<String, StageConfig>
    ) {
        operator fun String.invoke(configuration: StageConfig.() -> Unit) {
            val stage = objects.newInstance(StageConfig::class.java)
            stage.configuration()
